...
export default function AssistantThreadsStandalonePage() {
  ...
  let visible = [...threads];
  if (filterFrom) visible = visible.filter((t) => { const v = t[sortField]; return v ? v >= filterFrom : false; });
  if (filterTo) visible = visible.filter((t) => { const v = t[sortField]; return v ? v <= filterTo + "T23:59:59" : false; });
  visible.sort((a, b) => {
