...
export function ExportDataModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="card-panel relative max-w-lg w-full space-y-4 p-6 animate-in fade-in zoom-in-95 duration-200">
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="flex items-center gap-3 rounded-[20px] border-[3px] border-[var(--card-shell)] bg-[#fff9e6] px-4 py-3">
